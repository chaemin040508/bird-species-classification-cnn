...
## Dataset
- Dataset: CUB-200-2011 bird species dataset
- Classes: 200 bird species
- Train: 5,994 images
- Validation: 2,897 images
- Test: 2,897 images
- The final code uses bounding-box cropping before resizing images.
...
- Batch size: 32
- Epochs: 50
- Dropout: 0.5 in the uploaded final code
- Weight decay: 0.0001
- Label smoothing: 0.1
- Scheduler: CosineAnnealingLR with eta_min = 0.00001
- Random seed: 42
- Data augmentation: RandAugment, random crop, and horizontal flip
...
- `bird2-cub_aug_EffNetV2_correct_cases.png`
- `bird2-cub_aug_EffNetV2_failure_cases.png`
- `bird2-cub_aug_EffNetV2_confusion_matrix.png`
- `bird2-cub_aug_EffNetV2_report.txt`

## Inference Demo
The project presentation shows a Streamlit demo. The demo loads the trained checkpoint, preprocesses an uploaded bird image, and displays the predicted class, confidence score, and top-3 candidate classes.
